...
def getLocationsOfUser(userId):
    locations = global_db[global_db["user_id"] == userId]
    list = []
...
class MainApp(object):
    ...
    def createCheckInDataPerUser(self):
        ...
        self.df_unique_users.withColumn("user_locations", self.get_locations(self.df_unique_users["user_id"]))
        self.df_unique_users.registerTempTable("users")
